...
import imgAddProduto from "../../images/IMGCadastro.png"
        ...
        <div className="container d-flex justify-content-center align-items-center">
            <Row>
                <Col className="d-none d-lg-flex align-items-center justify-content-center rounded-start">
                    <Image src={imgAddProduto} alt="" />
                </Col>
                <Col className="bg-white shadow rounded-2 p-4">
                    <h2 className="texto">Cadastrar Produto</h2>
                                    ...
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control
                                            ...
                                            {...register("dataDesconto", {
                                                required: "A data deve ser maior que a data atual.",
                                            })}
