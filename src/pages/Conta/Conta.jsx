...
export function Conta() {
    ...
    useEffect(() => {
        axios.get(`https://e-commerce-server-423z.onrender.com/${autenticacao.tipo}es/${autenticacao.id}`, {
            headers: {
                        ...
                        <div className="w-100">
                            <Card className="align-items-center border-0" style={{ backgroundColor: '#FFAF00' }}>
                                <Card.Img
                                    ...
                                    src={usuario.foto ? `https://e-commerce-server-423z.onrender.com/${usuario.foto}` : 'https://e-commerce-server-423z.onrender.com/sacolinha.png'}
                                    alt="Foto do usuário"
                                />
                            </Card>
                            <br />
