...
export function NovoEmpreendedor() {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  function onSubmit(data) {
    ...
    axios
      .post("https://e-commerce-server-423z.onrender.com/empreendedores", formData)
      .then((response) => {
  ...
  return (
    <div className="container">
      <h5>Cadastro de Novo Empreendedor</h5>
            ...
            <Col>
              <Form.Group className="mb-2">
                ...
                <Form.Select
                  id="uf"
                  className={
                    errors.uf ? errors.uf && "is-invalid" : "custom-form-group"
                  }
                  {...register("uf", {
