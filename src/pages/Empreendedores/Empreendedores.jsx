...
export function Empreendedores() {
  ...
  const onDelete = async () => {
    try {
      await axios.delete(
        `https://e-commerce-server-423z.onrender.com/empreendedores/${idEmpreendedor}`,
        {
          headers: {
  ...
  async function initializeTable() {
    try {
      const response = await axios.get(
        `https://e-commerce-server-423z.onrender.com/empreendedores?nome=${filtroNome}&page=${atualPage}&size=${10}`,
        {
          headers: {
