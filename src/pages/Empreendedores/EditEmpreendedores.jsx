...
export function EditEmpreendedores() {
    ...
    function onSubmit(data) {
        ...
        axios
            .put(`https://e-commerce-server-423z.onrender.com/empreendedores/${id}`, formData, {
                headers: {
                    Authorization: `Bearer ${autenticacao.token}`,
                },
            })
            .then((response) => {
                toast.success("Empreendedor editado com sucesso.", {
                    position: "bottom-right",
                    duration: 2000,
                });
                if (autenticacao.tipo === 'empreendedor') {
                    navigate("/conta/empreendedor");
                } else {
    ...
    useEffect(() => {
        axios.get(`https://e-commerce-server-423z.onrender.com/empreendedores/${id}`).then((response) => {
            const {
                nome,
                email,
                endereco: { uf, cidade, cep, rua, numero }
            } = response.data;
                    ...
                    <Row>
                        <Col>
                            <Form.Group className="mb-2">
                                ...
                                <Form.Select
                                    id="uf"
                                    className={errors.uf ? errors.uf && "is-invalid" : "custom-form-group"}
                                    {...register("uf", {
                        ...
                        <Col>
                            <Form.Group className="mb-2">
                                ...
                                <Form.Select
                                    id="cidade"
                                    className={errors.cidade ? errors.cidade && "is-invalid" : "custom-form-group"}
                                    {...register("cidade", {
