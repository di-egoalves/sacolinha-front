...
export function Consumidores() {
    ...
    const onDelete = async () => {
        try {
            await axios.delete(`https://e-commerce-server-423z.onrender.com/consumidores/${idConsumidor}`, {
                headers: {
    ...
    async function initializeTable() {
        try {
            const response = await axios.get(`https://e-commerce-server-423z.onrender.com/consumidores?nome=${filtroNome}&page=${atualPage}&size=${10}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
                }
            });
