...
export function EditSenhaConsumidor() {
  ...
  function onSubmit(data) {
    axios
      .put(`https://e-commerce-server-423z.onrender.com/consumidores/senha/${id}`, data, {
        headers: {
  ...
  useEffect(() => {
    axios
      .get(`https://e-commerce-server-423z.onrender.com/consumidores/senha${id}`)
      .then((response) => {
    ...
    <div className="container p-5">
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <hr/>
          ...
          <Button variant="danger text-white" type="submit" as={Link} to={'/conta/consumidor'}>
            Cancelar
          </Button>
          </div>
      </Form>
